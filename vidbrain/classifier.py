...
_TECH_KEYWORDS = [
    # 技术类
    "编程", "Python", "Go", "Rust", "算法", "架构", "源码", "设计模式",
    "区块链", "Web3", "智能合约", "Solidity", "EVM", "DeFi", "NFT",
    "AI", "LLM", "大模型", "机器学习", "深度学习", "神经网络",
    "Kubernetes", "Docker", "Linux", "数据库", "后端", "前端", "DevOps",
    "面试", "面经", "LeetCode", "刷题", "程序员",
    "GPU", "CUDA", "算子", "推理", "训练", "模型",
    "微服务", "分布式", "高并发", "性能优化", "系统设计",
    "Git", "API", "REST", "gRPC", "协议",
    "Java", "Redis", "JVM", "Spring", "C语言", "C++", "JavaScript", "TypeScript",
    # 知识类
    "科普", "原理", "深度", "解析", "拆解", "底层", "认知",
    "方法论", "思维", "经济", "物理", "数学",
    "科学", "技术", "创业", "复盘", "演讲", "讲座", "代码", "软件",
    # 课程类
    "教程", "课程", "教学", "入门", "进阶", "实战", "训练营", "公开课",
    # 观点类
    "观点", "思辨", "评论", "分析", "讨论", "对话", "对谈", "播客",
    "访谈", "圆桌", "辩论", "座谈", "对讲",
    # 公司与产品
    "谷歌", "Google", "Apple", "微软", "Meta", "Amazon", "AWS",
    "iPhone", "Mac", "Windows",
]
